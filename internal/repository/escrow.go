...
func (r *EscrowRepository) Create(ctx context.Context, tx pgx.Tx, escrow *models.EscrowTransaction) error {
	query := `
...
func (r *EscrowRepository) UpdateStatus(ctx context.Context, tx pgx.Tx, id uuid.UUID, status models.EscrowStatus, releasedAt *time.Time) error {
